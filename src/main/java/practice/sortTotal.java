 ...
 * http://blog.csdn.net/fansy1990/article/details/37927719?utm_source=tuicool&utm_medium=referral
 * 排序，实现输出文件全局有序
 */
...
public class sortTotal extends Configured implements Tool {

    //map将输入中的value化成LongWritable类型，作为输出的key
    public static class Map extends Mapper<Object,Text,LongWritable,NullWritable>{
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(sortTotal.class);
...
//      RandomSampler第一个参数表示key会被选中的概率，第二个参数是一个选取samples数，第三个参数是最大读取input splits数
        MyInputSampler.Sampler<Text, Text> sampler = new MyInputSampler.RandomSampler<Text, Text>(0.1,5,3);
    ...
    public static void main(String[] args) throws Exception{
        ...
        ToolRunner.run(new Configuration(), new sortTotal(),args);
